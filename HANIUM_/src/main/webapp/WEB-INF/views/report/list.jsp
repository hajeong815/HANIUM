   ...
   <div class="container">
      ...
      <p>부적합 보고서 검색</p>         
	      <div class="input-group" >
	               ...
	               <div class="btn-group">
	                 <select id="cda_code" name="cda_code"  style="height:30px; width:auto; margin:0px">
	      	...
	      	<div class="input-group" style="margin-top:20px">
	               ...
	               <div class="btn-group">                       
	                    <input type="text" id="content" name="content" style="background-color:ffffff; border:1px solid; height:30px; width:250px; margin-right:50px" placeholder="내용을 입력하세요."></input>
	               </div>
